                ...
                @foreach($projects as $project)
                  <tr>
                    <td>
                      ...
                      @if($project->is_owner)
                        <form role="form" action="{{ '/project/'.$project->id.'/delete' }}" method="post"><input type="hidden" name="_token" value="{{ csrf_token() }}"><button class="btn-delete"><i class="fa fa-times-circle"></i></button></form>
                      @endif
                    </td>
                  </tr>
                @endforeach
